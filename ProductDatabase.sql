...
GO
PRINT N'Creating Login [dbsafe]...';


GO
CREATE LOGIN [dbsafe]
    WITH PASSWORD = N'dbsafe', CHECK_POLICY = OFF;


GO
PRINT N'Creating User [dbsafe]...';


GO
CREATE USER [dbsafe] FOR LOGIN [dbsafe];


GO
REVOKE CONNECT TO [dbsafe];
...
GO
EXECUTE sp_addrolemember @rolename = N'db_owner', @membername = N'dbsafe';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Product_Supplier]...';


GO
ALTER TABLE [dbo].[Product]
    ADD CONSTRAINT [FK_Product_Supplier] FOREIGN KEY ([SupplierId]) REFERENCES [dbo].[Supplier] ([Id]);
...
GO
PRINT N'Creating View [dbo].[uw_Product]...';
...
GO
PRINT N'Creating Procedure [dbo].[usp_GetDate]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[usp_AddProduct]...';
